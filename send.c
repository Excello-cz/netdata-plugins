...
void
print_send_hdr() {
	nd_chart("qmail.send", "send qmail", "Qmail send", "# send", "send", "send", ND_CHART_TYPE_LINE);
	...
	nd_chart("qmail.send_delivery", "send delivery", "Qamil Send delivery", "# deliveries", "send",
